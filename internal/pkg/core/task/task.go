...
type Interface interface {
	...
	UpdateTitle(ctx context.Context, id uint, title string) (*models.Task, error)
	Delete(ctx context.Context, id uint) (*models.Task, error)
	Complete(ctx context.Context, id uint) (*models.Task, error)
...
func (c *core) Delete(ctx context.Context, id uint) (*models.Task, error) {
...
func (c *core) Complete(ctx context.Context, id uint) (*models.Task, error) {
...
func (c *core) Get(ctx context.Context, id uint) (*models.Task, error) {
